 ...
 */
public class RecentTracksFragment extends TrackBrowserFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        loader.loadAsync(UserCategory.RECENT, new TrackLoader.Listener() {
    ...
    CharSequence getTitle(Resources resources) {
        return resources.getString(R.string.category_recent);
    }
}
